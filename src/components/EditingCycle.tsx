import { CheckCheck, FileCheck, Search, SquarePen } from "lucide-react";
...
const steps = [
  {
    ...
    title: "Assessment",
    description:
      "We evaluate your manuscript to determine the optimal level of editing required.",
  },
  {
    number: 2,
    icon: SquarePen,
    title: "Deep Edit",
    description:
      "Our editors address structure, flow, and clarity throughout the entire work.",
  },
  {
    number: 3,
    icon: Search,
    title: "Final Polish",
    description:
      "A meticulous final pass to eliminate all remaining technical and style errors.",
  },
  {
    number: 4,
    icon: CheckCheck,
    title: "Delivery",
    description:
      "You receive a clean manuscript along with a detailed tracked changes document.",
  },
];

export default function EditingCycle() {
  return (
      ...
      <div className="site-container relative">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-5 font-heading text-[36px] leading-tight font-semibold sm:text-[42px] lg:text-[48px]">
            <span className="text-primary">Our Path to </span>
          ...
          <p className="mt-4 font-body text-sm leading-relaxed text-black/70 sm:text-[15px]">
            A structured, multi-pass approach aligned with Stamford
            Publishers&apos; author-focused publishing process.
          </p>
        </div>
